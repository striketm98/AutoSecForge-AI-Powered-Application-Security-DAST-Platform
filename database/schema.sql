...
SET @colname = 'client_logo_path';
SET @sql = (SELECT IF(
    (SELECT COUNT(*) FROM information_schema.COLUMNS
     WHERE TABLE_SCHEMA = @dbname AND TABLE_NAME = @tablename AND COLUMN_NAME = @colname) = 0,
    CONCAT('ALTER TABLE `', @tablename, '` ADD COLUMN `', @colname, '` VARCHAR(255) DEFAULT NULL'),
    'SELECT 1'
));
...
SET @dbname = DATABASE();
SET @tablename = 'projects';
SET @colname = 'source_username';
SET @sql = (SELECT IF(
    (SELECT COUNT(*) FROM information_schema.COLUMNS
     WHERE TABLE_SCHEMA = @dbname AND TABLE_NAME = @tablename AND COLUMN_NAME = @colname) = 0,
    CONCAT('ALTER TABLE `', @tablename, '` ADD COLUMN `', @colname, '` VARCHAR(160) DEFAULT NULL'),
    'SELECT 1'
));
PREPARE stmt FROM @sql;
EXECUTE stmt;
...
SET @dbname = DATABASE();
SET @tablename = 'projects';
SET @colname = 'source_password_hint';
SET @sql = (SELECT IF(
    (SELECT COUNT(*) FROM information_schema.COLUMNS
     WHERE TABLE_SCHEMA = @dbname AND TABLE_NAME = @tablename AND COLUMN_NAME = @colname) = 0,
    CONCAT('ALTER TABLE `', @tablename, '` ADD COLUMN `', @colname, '` VARCHAR(255) DEFAULT NULL'),
...
SET @colname = 'vendor_name';
SET @sql = (SELECT IF(
    (SELECT COUNT(*) FROM information_schema.COLUMNS
     WHERE TABLE_SCHEMA = @dbname AND TABLE_NAME = @tablename AND COLUMN_NAME = @colname) = 0,
    CONCAT('ALTER TABLE `', @tablename, '` ADD COLUMN `', @colname, '` VARCHAR(120) DEFAULT NULL'),
    'SELECT 1'
));
PREPARE stmt FROM @sql;
EXECUTE stmt;
...
SET @dbname = DATABASE();
SET @tablename = 'integrations';
SET @colname = 'integration_profile';
SET @sql = (SELECT IF(
    (SELECT COUNT(*) FROM information_schema.COLUMNS
     WHERE TABLE_SCHEMA = @dbname AND TABLE_NAME = @tablename AND COLUMN_NAME = @colname) = 0,
    CONCAT('ALTER TABLE `', @tablename, '` ADD COLUMN `', @colname, '` VARCHAR(80) DEFAULT NULL'),
    'SELECT 1'
));
PREPARE stmt FROM @sql;
EXECUTE stmt;
...
SET @dbname = DATABASE();
SET @tablename = 'integrations';
SET @colname = 'auth_type';
SET @sql = (SELECT IF(
    (SELECT COUNT(*) FROM information_schema.COLUMNS
     WHERE TABLE_SCHEMA = @dbname AND TABLE_NAME = @tablename AND COLUMN_NAME = @colname) = 0,
    CONCAT('ALTER TABLE `', @tablename, '` ADD COLUMN `', @colname, '` VARCHAR(40) DEFAULT NULL'),
    'SELECT 1'
));
PREPARE stmt FROM @sql;
EXECUTE stmt;
...
SET @dbname = DATABASE();
SET @tablename = 'integrations';
SET @colname = 'last_tested_at';
SET @sql = (SELECT IF(
    (SELECT COUNT(*) FROM information_schema.COLUMNS
     WHERE TABLE_SCHEMA = @dbname AND TABLE_NAME = @tablename AND COLUMN_NAME = @colname) = 0,
    CONCAT('ALTER TABLE `', @tablename, '` ADD COLUMN `', @colname, '` DATETIME DEFAULT NULL'),
    'SELECT 1'
));
PREPARE stmt FROM @sql;
EXECUTE stmt;
...
SET @dbname = DATABASE();
SET @tablename = 'imports';
SET @colname = 'source_detail';
SET @sql = (SELECT IF(
    (SELECT COUNT(*) FROM information_schema.COLUMNS
     WHERE TABLE_SCHEMA = @dbname AND TABLE_NAME = @tablename AND COLUMN_NAME = @colname) = 0,
    CONCAT('ALTER TABLE `', @tablename, '` ADD COLUMN `', @colname, '` VARCHAR(255) DEFAULT NULL'),
...
SET @dbname = DATABASE();
SET @tablename = 'findings';
SET @colname = 'claimed_by';
SET @sql = (SELECT IF(
    (SELECT COUNT(*) FROM information_schema.COLUMNS
     WHERE TABLE_SCHEMA = @dbname AND TABLE_NAME = @tablename AND COLUMN_NAME = @colname) = 0,
    CONCAT('ALTER TABLE `', @tablename, '` ADD COLUMN `', @colname, '` VARCHAR(160) DEFAULT NULL'),
...
SET @dbname = DATABASE();
SET @tablename = 'findings';
SET @colname = 'ai_issue_summary';
SET @sql = (SELECT IF(
    (SELECT COUNT(*) FROM information_schema.COLUMNS
     WHERE TABLE_SCHEMA = @dbname AND TABLE_NAME = @tablename AND COLUMN_NAME = @colname) = 0,
    CONCAT('ALTER TABLE `', @tablename, '` ADD COLUMN `', @colname, '` TEXT DEFAULT NULL'),
    'SELECT 1'
));
PREPARE stmt FROM @sql;
EXECUTE stmt;
...
SET @dbname = DATABASE();
SET @tablename = 'attack_surface_assets';
SET @colname = 'asset_url';
SET @sql = (SELECT IF(
    (SELECT COUNT(*) FROM information_schema.COLUMNS
     WHERE TABLE_SCHEMA = @dbname AND TABLE_NAME = @tablename AND COLUMN_NAME = @colname) = 0,
    CONCAT('ALTER TABLE `', @tablename, '` ADD COLUMN `', @colname, '` VARCHAR(255) DEFAULT NULL'),
...
SET @dbname = DATABASE();
SET @tablename = 'attack_surface_history';
SET @colname = 'asset_id';
SET @sql = (SELECT IF(
    (SELECT COUNT(*) FROM information_schema.COLUMNS
     WHERE TABLE_SCHEMA = @dbname AND TABLE_NAME = @tablename AND COLUMN_NAME = @colname) = 0,
    CONCAT('ALTER TABLE `', @tablename, '` ADD COLUMN `', @colname, '` INT DEFAULT NULL'),
    'SELECT 1'
));
PREPARE stmt FROM @sql;
EXECUTE stmt;
...
SET @sql = (SELECT IF(
    (SELECT COUNT(*) FROM information_schema.COLUMNS
     WHERE TABLE_SCHEMA = @dbname AND TABLE_NAME = @tablename AND COLUMN_NAME = @colname) = 0,
    CONCAT('ALTER TABLE `', @tablename, '` ADD COLUMN `', @colname, '` VARCHAR(160) NOT NULL'),
    'SELECT 1'
));
PREPARE stmt FROM @sql;
EXECUTE stmt;
